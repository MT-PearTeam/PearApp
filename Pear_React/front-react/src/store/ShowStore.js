import logo from './pear-icon.png';
        ...
        <div className="container">
            <nav class="navbar navbar-dark bg-dark" >
                <div class="container-fluid">
                    <a class="navbar-brand" onClick={(e)=>navigate('/')}><img src={logo} width="30" height="24"/>Inicio</a>
                    <a class="navbar-brand" aria-current="page" onClick={(e)=>navigate('/buy')}><i class="fa-solid fa-cart-shopping"></i> Carrito</a>
                    ...
                    <div className="col">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <Link to="/buy/" className="btn btn-warning"><i class="fa-solid fa-bag-shopping"></i></Link>
                                </td>
                    ...
                    <div className='row justify-content-center my-5'> {/* linea 36 para cambios paso 46 */}
                        <div className='col nonborder rounded-3 my-auto mx-auto'>
                            <form className="form-control-lg" >
                                <button type="submit" className="btn btn-outline-warning mx-3 p-3" onClick={(e)=>navigate('/')}><i class="fa-regular fa-circle-left"></i> Inicio</button>
                            </form>
                        </div>                
                    </div>
                </div>
