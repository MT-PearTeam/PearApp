        ...
        <div className="container">
            <nav class="navbar navbar-dark bg-dark" >
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" aria-current="page" onClick={(e)=>navigate('/store')}><i class="fa-solid fa-shop-lock"></i> Tienda</a>
            ...
            <div className="col border rounded-3 my-4">
                ...
                <div className="justify-content-center">
                    <button onClick={()=>pagar()} className="btn btn-outline-primary px-3"><i class="fa-solid fa-bag-shopping"></i> Pagar</button>
